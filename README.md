...
- **Distraction shield** — block whole apps *and* specific websites. Opening one mid-focus drops a gentle full-screen nudge with your intention on it (Back to focus / Close the tab / 1-minute peek / End session). Site detection reads the active tab in Chrome, Safari, Brave, Edge & Arc via Apple Events; domains match subdomains, and keywords without a dot match anywhere ("n12" blocks n12.co.il). Ships with 8 one-click presets — social media, WhatsApp & chats (app + web), Israeli news, US & world news, streaming, shopping, sports, tech rabbit holes.
- **Music & soundscapes** — four AI-generated seamless loops (Trance Focus, Deep Techno, Lofi Beats, Ambient Drift) plus procedurally synthesized Deep Noise / Rainfall / Ocean. Drop extra tracks into `~/Library/Application Support/Focus/Music` and they appear in the menu.
